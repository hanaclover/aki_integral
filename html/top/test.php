...
<html>
<!--  パス
//htdocs/aki_integral/aki_integral/html/top/test.php
  -->
<head>
<meta charset='UTF8'>
<meta http-equiv="content-style-type" content="text/css" />
<meta http-equiv="content-script-type" content="text/javascript" />
<link rel="stylesheet" type="text/css" href="../../css/top/test.css"/>
<script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.7.1/jquery.min.js"></script>
<script type="text/javascript" src="../../js/top/test.js"></script> 
</head>
...
<?php } ?>
	...
	<div id="mainColumn">
		...
		<div><img id="osusume" src="../../img/osusume.jpg" width="400px" height="300px"></div>
	...
	<div id="sideColumn">
		<button class="reserveBt" onclick="location.href='../reserve/reserve_top.php'">ご予約はこちらから</button>
	</div>
	<div>
